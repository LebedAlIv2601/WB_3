...
class MainConstraintFragment : Fragment() {
    ...
    private fun setupListeners() {
        ...
        binding?.apply {
            ...
            constraintScreenThree.setOnClickListener {
                navController.navigate(R.id.action_mainConstraintFragment_to_thirdConstraintFragment)
            }

            noConstraintScreenThree.setOnClickListener {
                navController.navigate(R.id.action_mainConstraintFragment_to_thirdNoConstraintFragment)
            }

            constraintScreenFour.setOnClickListener {
                navController.navigate(R.id.action_mainConstraintFragment_to_fourthConstraintFragment)
            }

            noConstraintScreenFour.setOnClickListener {
                navController.navigate(R.id.action_mainConstraintFragment_to_fourthNoConstraintFragment)
            }
        }
    }
